...
These are the main service images:
  ...
  * [![Build Status](https://travis-ci.org/cyber-dojo/starter.svg?branch=master)](https://travis-ci.org/cyber-dojo/starter) [storer](https://github.com/cyber-dojo/starter) - stores the language+testFramework/exercise start-points

...
The [cyber-dojo-start-points](https://github.com/cyber-dojo-start-points) Org contains 80+ git repositories, one for each language+testFramework's starting source files. 
For example:
...
Each repo contains a `start_point` directory containing the initial source files (typically one code file and one test file), and a `manifest.json` file containing the _name_ of the docker image they run inside.

[ways to CONTRIBUTE](https://github.com/cyber-dojo/cyber-dojo/blob/master/docs/how-to-contribute-to-start-points.md)


## Exercises - such as 'Fizz Buzz'
...
Each exercise consists of a single `manifest.json` file specifying the display name of the exercise, and a readme instructions file.

[ways to CONTRIBUTE](https://github.com/cyber-dojo/exercises-start-points/blob/main/CONTRIBUTING.md)


## Custom start-points - such as 'Yahtzee'

The [custom-start-points](https://github.com/cyber-dojo/custom-start-points) repo in the cyber-dojo Org holds the custom start points. For example:
...
[ways to CONTRIBUTE](https://github.com/cyber-dojo/custom-start-points/blob/main/CONTRIBUTING.md)
...
[ways to CONTRIBUTE](https://github.com/cyber-dojo/cyber-dojo/blob/master/docs/how-to-contribute-to-server.md)

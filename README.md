...
- [![CircleCI](https://circleci.com/gh/cyber-dojo/exercises-chooser.svg?style=svg)](https://circleci.com/gh/cyber-dojo/exercises-chooser) [exercises-chooser](https://github.com/cyber-dojo/exercises-chooser) - an html page to choose a problem when creating an exercise.
...
- [![CircleCI](https://circleci.com/gh/cyber-dojo/languages-chooser.svg?style=svg)](https://circleci.com/gh/cyber-dojo/languages-chooser) [languages-chooser](https://github.com/cyber-dojo/languages-chooser) - an html page to choose a language,testFramework when creating an exercise.
...
- [![CircleCI](https://circleci.com/gh/cyber-dojo/saver.svg?style=svg)](https://circleci.com/gh/cyber-dojo/saver) [saver](https://github.com/cyber-dojo/saver) - persists group and individual exercises and all code/test files (in a host dir volume-mounted to `/cyber-dojo`).
